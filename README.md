...
2. **Unidad 3 (Enfoque Práctico/Código):** Desarrollada directamente aquí en **GitHub** mediante control de versiones y modelado práctico.
...
*   **Fase 2:** Construcción de Tablas de Verdad y Operaciones.
*   **Fase 3:** Equivalencias Lógicas y Formas Normales.
*   **Fase 4:** Inferencia Lógica y Razonamiento Deductivo.
*   **Fase 5:** Tautologías, Contradicciones y Argumentos Válidos.
...
*   **Fase 2:** Simplificación Algebraica de Expresiones Booleanas.
*   **Fase 3:** Mapas de Karnaugh de 2 y 3 variables.
*   **Fase 4:** Mapas de Karnaugh de 4 variables y Formas Canónicas.
*   **Fase 5:** Propiedades Adicionales del Álgebra de Boole (Análisis aplicado a sistemas computacionales).
